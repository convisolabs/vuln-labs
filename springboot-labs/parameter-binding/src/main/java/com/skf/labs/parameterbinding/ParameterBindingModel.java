...
public class ParameterBindingModel {
    ...
    public boolean createUser(User user) {
        ...
        // Devemos ter uma rota para criar contas de administrador em produção?
        // Se sim, essa rota deveria ser somente por outros admins...
        // Object[] args = new Object[] { user.getUsername(), user.getPassword(), false
        // };
